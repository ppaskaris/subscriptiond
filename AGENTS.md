...
- After a successful build, run applicable validation sequentially in this order: tests excluding LocalDB and Cosmos, LocalDB integration tests, then Cosmos emulator tests. Do not overlap these runs.
