...
namespace youtubed
{
    public static class Constants
    {
        ...
        public static readonly TimeSpan ChannelMaxAgeMax = TimeSpan.FromMinutes(60);
        public static readonly TimeSpan ChannelMaxAgeMin = TimeSpan.FromMinutes(90);
        ...
        public static readonly TimeSpan VisibilityTimeoutMax = TimeSpan.FromMinutes(4);
        public static readonly TimeSpan VisibilityTimeoutMin = TimeSpan.FromMinutes(6);
